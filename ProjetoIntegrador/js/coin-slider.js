	...
	$.fn.coinslider = $.fn.CoinSlider = function (options) {
		...
		var setNavigation = function (el) {
			...
			if (params[el.id].showNavigationPrevNext) {
				...
				//$('#cs-navigation-' + el.id).append("<a href='#' id='cs-prev-" + el.id + "' class='cs-prev'><img src='../ProjetoIntegrador/Imagens/flecha.png' style='margin; 0 auto; width:80px; transform: rotateY(180deg);'/>"+params[el.id].prevText+"</a>");
